...
dashboard_page <- grid(main_layout,
                       ...
                       dashboard_panel = grid(
                         ...
                         dashboard_kpi = div(class = "ui four column stackable grid",
                                             div(class = "column",
  ...
  output$last_observed_date <- renderUI({
    ...
    div(class = "ui raised link card",
        ...
        div(class = "right aligned content",
            div(class = "center aligned header", "Last observerd on..."),
            div( class = "left aligned",
                 icon("big calendar alternate"),
                 div(class = "ui right aligned tiny horizontal statistic",
